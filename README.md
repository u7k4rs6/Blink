...
| Doc | What it is |
|-----|------------|
| [`docs/00-verification.md`](docs/00-verification.md) | Phase 0. Every [UNVERIFIED] claim in the other four docs, checked against live sources, with verdicts, source URLs and quoted evidence. Also the two contradictions found, and the decisions taken on them. |
| [`docs/01-prd.md`](docs/01-prd.md) | Product requirements, budget model, D1 to D12, open questions Q1 to Q17. |
| [`docs/02-architecture.md`](docs/02-architecture.md) | Technical architecture. Section 8.1 is the counting fetch, section 8.2 is the three-layer expiry. |
| [`docs/03-security-and-access.md`](docs/03-security-and-access.md) | Threat model T1 to T12 and the controls, for a site that hands strangers a Linux sandbox on one key. |
| [`docs/04-frontend-spec.md`](docs/04-frontend-spec.md) | Frontend spec. |
